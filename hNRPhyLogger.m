classdef hNRPhyLogger < handle
    ...
    methods (Access = public)
        function obj = hNRPhyLogger(simParameters, varargin)
            ...
            %
            % OBJ = hNRPhyLogger(SIMPARAMETERS, NETWORKSIMULATOR, GNB, UEs)
            % Create a Phy logging object for logging the traces.
            %
            % NETWORKSIMULATOR - Network simulator object of type hWirelessNetworkSimulator
            %
            % GNB - It is a scalar and object of type hNRGNB
            %
            % UEs - It is a cell array of node objects of type hNRUE
            %
            % OBJ = hNRPhyLogger(SIMPARAMETERS) Create a Phy logging object
            % used for post-simulation visualization.
            %
            ...
            if numel(varargin) == 3
                ...
                phyLogPeriodicity = ((15/simParameters.SCS)/14) * 1e-3; % In seconds
        ...
        function [dlPhyMetrics, ulPhyMetrics] = getPhyMetrics(obj, firstSlot, lastSlot, rntiList)
          ...
          function logCellPhyStats(obj)
            ...
            for ueIdx = 1:obj.NumUEs
                stats = obj.UEs{ueIdx}.PhyEntity.DLBlkErr;
