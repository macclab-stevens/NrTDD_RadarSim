classdef hNRRLCLogger < handle
    ...
    methods (Access = public)
        function obj = hNRRLCLogger(simParameters, lchInfo, varargin)
            ...
            % logging object
            %
            % OBJ = hNRRLCLogger(SIMPARAMETERS, LCHINFO, NETWORKSIMULATOR,
            % GNB, UEs) Create an RLC logging object
            %
        ...
        function logCellRLCStats(obj)
            ...
            for ueIdx = 1:obj.NumUEs
                % Get RLC statistics
                stats = getRLCStatistics(obj.UEs{ueIdx}, ueIdx);
                ...
                stats = getRLCStatistics(obj.GNB, ueIdx);
