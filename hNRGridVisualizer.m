        ...
        function updateResourceGridVisualization(obj)
            ...
            for n = lowLogIdx+1 : uppLogIdx
                for p = obj.RGLowerRBIndex + 1 : obj.RGUpperRBIndex
                    ...
                    rnti = obj.ResourceGridTextHandles(n, p).String;
                    if ~isempty(rnti)
                        rnti = convertCharsToStrings(rnti);
                        rnti = extractBetween(rnti,"-","(");
                        rnti = str2num(rnti);
                        % https://www.rapidtables.com/web/color/html-color-codes.html
                        switch rnti
                        case 1
                            obj.ResourceGridTextHandles(n, p).BackgroundColor = '#FFC4E4'; %lightPink
                        case 2
                            obj.ResourceGridTextHandles(n, p).BackgroundColor = '#A8FFC2'; %lightGreen
                        case 3
                            obj.ResourceGridTextHandles(n, p).BackgroundColor = '#C4F8FF'; %lightBlue
                        case 4
                            obj.ResourceGridTextHandles(n, p).BackgroundColor = '#FFF7A8'; %lightYellow
                        otherwise
                            obj.ResourceGridTextHandles(n, p).BackgroundColor = 'white'; 
                        end
                    ...
                    if(obj.ResourceGridReTxInfo{obj.RVCurrView}(n, p) == 2) % Re-Tx
                        ...
                        % obj.ResourceGridTextHandles(n, p).BackgroundColor = 'red';
                    end
                end
            end
            drawnow;
