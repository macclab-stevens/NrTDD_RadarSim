...
%   Copyright 2019-2022 The MathWorks, Inc.
    ...
    properties (Access = protected)
        ...
        %SlotDurationInNS Slotduaration in nanoseconds
        SlotDurationInNS
        %NumSymInFrame  Number of symbols in a 10 ms frame
        NumSymInFrame
        %TimingInfo Structure that holds the timing information
        TimingInfo = struct('SFN', 0, 'CurrSlot', 0, 'CurrSymbol', 0, 'Timestamp', 0)
    end
    ...
    methods (Access = public)
        ...
        function csirsInfo = calculateCSIRSPeriodicity(obj, csirsResourceConfig)
            ...
            count = 0;
            csirsInfo = inf(1, 1);
            for idx=1:length(csirsResourceConfig)
